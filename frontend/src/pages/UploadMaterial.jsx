...
const categories = ['Plastic', 'Metal', 'Chemical', 'Textile', 'Wood', 'E-waste']
const units = ['kg', 'tonnes']
...
export default function UploadMaterial() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || err.message || 'Failed to list material.')
      setSubmitting(false)
    }
  }
  ...
  return (
    <div className="flex min-h-screen items-start justify-center bg-surface px-6 py-12">
      <Card className="w-full max-w-2xl">
        <h1 className="font-heading text-2xl font-bold text-ink">List Surplus Material</h1>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-5">
          ...
          >
            {submitting ? 'Listing…' : 'List Material'}
          </Button>
        </form>
      </Card>
    </div>
